...
const SELECT_WORK_RAM_BANK_ADDRESS: usize = 0xFF70;
...
impl RamController {
    pub fn new() -> Self {
        Self {
            work_ram: vec![0u8, WORK_RAM_SIZE * 2],
            high_ram: vec![0u8, HIGH_RAM_SIZE],
        }
    }

    pub fn write_work_ram(&mut self, address: u16, value: u8) {
        self.work_ram[address - WORK_RAM_START_ADDRESS] = value;
    }

    pub fn read_work_ram(&mut self, address: u16) -> u8 {
        self.work_ram[address - WORK_RAM_START_ADDRESS]
    }
    ...
    pub fn write_high_ram(&mut self, address: u16, value: u8) {
        self.high_ram[address - WORK_RAM_START_ADDRESS] = value;
    }

    pub fn read_high_ram(&mut self, address: u16) -> u8 {
        self.high_ram[address - WORK_RAM_START_ADDRESS]
    }

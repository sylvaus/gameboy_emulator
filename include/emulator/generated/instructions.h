...
namespace emulator::generated
{
    ...
    using InstructionFunction = std::function<uint16_t (const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller)>;
    ...
    uint16_t inc_003(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x3 INC BC

    uint16_t inc_004(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x4 INC B

    uint16_t dec_005(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x5 DEC B

    uint16_t ld_006(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x6 LD B, d8

    uint16_t rlca_007(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x7 RLCA
    ...
    uint16_t add_009(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x9 ADD HL, BC

    uint16_t ld_00a(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0xA LD A, (BC)

    uint16_t dec_00b(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0xB DEC BC

    uint16_t inc_00c(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0xC INC C

    uint16_t dec_00d(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0xD DEC C

    uint16_t ld_00e(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0xE LD C, d8

    uint16_t rrca_00f(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0xF RRCA
    ...
    uint16_t inc_013(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x13 INC DE

    uint16_t inc_014(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x14 INC D

    uint16_t dec_015(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x15 DEC D

    uint16_t ld_016(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x16 LD D, d8

    uint16_t rla_017(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x17 RLA

    uint16_t jr_018(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x18 JR r8

    uint16_t add_019(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x19 ADD HL, DE

    uint16_t ld_01a(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x1A LD A, (DE)

    uint16_t dec_01b(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x1B DEC DE

    uint16_t inc_01c(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x1C INC E

    uint16_t dec_01d(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x1D DEC E

    uint16_t ld_01e(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x1E LD E, d8

    uint16_t rra_01f(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x1F RRA

    uint16_t jr_020(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x20 JR NZ, r8
    ...
    uint16_t inc_023(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x23 INC HL

    uint16_t inc_024(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x24 INC H

    uint16_t dec_025(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x25 DEC H

    uint16_t ld_026(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x26 LD H, d8

    uint16_t daa_027(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x27 DAA

    uint16_t jr_028(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x28 JR Z, r8

    uint16_t add_029(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x29 ADD HL, HL
    ...
    uint16_t dec_02b(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x2B DEC HL

    uint16_t inc_02c(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x2C INC L

    uint16_t dec_02d(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x2D DEC L

    uint16_t ld_02e(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x2E LD L, d8

    uint16_t cpl_02f(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x2F CPL

    uint16_t jr_030(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x30 JR NC, r8
    ...
    uint16_t inc_033(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x33 INC SP

    uint16_t inc_034(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x34 INC (HL)

    uint16_t dec_035(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x35 DEC (HL)
    ...
    uint16_t scf_037(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x37 SCF

    uint16_t jr_038(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x38 JR C, r8

    uint16_t add_039(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x39 ADD HL, SP
    ...
    uint16_t dec_03b(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x3B DEC SP

    uint16_t inc_03c(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x3C INC A

    uint16_t dec_03d(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x3D DEC A

    uint16_t ld_03e(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x3E LD A, d8

    uint16_t ccf_03f(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x3F CCF
    ...
    uint16_t add_080(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x80 ADD A, B

    uint16_t add_081(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x81 ADD A, C

    uint16_t add_082(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x82 ADD A, D

    uint16_t add_083(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x83 ADD A, E

    uint16_t add_084(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x84 ADD A, H

    uint16_t add_085(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x85 ADD A, L

    uint16_t add_086(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x86 ADD A, (HL)

    uint16_t add_087(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0x87 ADD A, A

    uint16_t add_0c6(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0xC6 ADD A, d8
    ...
    uint16_t add_0e8(const Arguments& arguments, emulator::Registers& registers, emulator::MemoryController& controller); // 0xE8 ADD SP, r8
